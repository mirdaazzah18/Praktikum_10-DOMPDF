           ...
           <div class="card">
             ...
             <div class="card-body">
               ...
               <form action="simpan.php" method="post">
                 ...
                 <!-- Pembuatan button submit dan mengimpor data ke excel -->
                 <div class="form-group row">
                   <div class="col-sm-10">
               ...
               <a href="reportpendaftaran.php"><button type="submit" class="btn btn-primary">Tampilkan Data di PDF</button></a>
             </div>
           </div>
         </div>
       </div>
